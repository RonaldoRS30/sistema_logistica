...
class SegUsuario(models.Model):
    ...
    def get_area_nombre(self):
        from logistica_api.models import VcTabAreas
        try:
    ...
    def get_cargo_nombre(self):
        from logistica_api.models import VcTabCargos
        try:
    ...
    def get_banco_nombre(self):
        from logistica_api.models import VcTabBancos
        try:
...
class vc_mov_cotizaciones(models.Model):
    ...
    def area_nombre(self):
        try:
            from logistica_api.models import vc_tab_areas
            if not self.area:
                return ""
