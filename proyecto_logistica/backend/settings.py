...
MIGRATION_MODULES = {
    'logistica_api': None,  # Django no intentará migrar esta app todavía
}

# ---------------------------
# Usuario personalizado
# ---------------------------
AUTH_USER_MODEL = "logistica_api.SegUsuario"
...
# Usuario personalizado
# ---------------------------
AUTH_USER_MODEL = "logistica_api.SegUsuario"  # tu modelo reutilizado
